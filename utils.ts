...
// v5.4 — 2026-03-27 — EO-160c: Removed cost reset from safeMerge — was firing on every
//         loadProject(), not just JSON import. Cost reset moved to import handler in App.tsx.
